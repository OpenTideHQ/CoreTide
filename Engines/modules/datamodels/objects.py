        ...
        class Objective:
            ...
            class Signal:
                ...
                class External:
                    ...
                    name: str
                    """Name of the external detector, either as documented by the vendor if available,
                    else close to the alerts generated by the tool."""
                    technology: str
                    """The technology that contains the detector this signal is mapping to."""
                    description: str
                ...
                external: Optional[List[External]] = None
